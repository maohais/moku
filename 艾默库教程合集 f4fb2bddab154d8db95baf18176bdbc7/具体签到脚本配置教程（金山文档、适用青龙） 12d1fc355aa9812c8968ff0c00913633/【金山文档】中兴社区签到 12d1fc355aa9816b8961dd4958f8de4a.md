...
[https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16APacbEqOaD9OkNZhPU22DLhWstyDF3dTtnKVCnvwcgfQrDqjKCMcaFQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1](https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16APacbEqOaD9OkNZhPU22DLhWstyDF3dTtnKVCnvwcgfQrDqjKCMcaFQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

需要AccessToken。APP用抓包工具抓取所需的值或者网页端获取所需得值，如图复制所需要的值，如:xxxxxxxx。此值后面表格中需要用到。

文字步骤如下：

1.第一步，浏览器访问网页版中兴社区，网址为
...
3.第三步，点击任意一个含有AccessToken的包（点击签到必含有此值的包）

4.第四步，右侧找到"AccessToken"并复制，如图中的xxxxxxxx
...
[https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16ABjEZaBrhhacicBOk87DRb84oRJGWicBbFn33JPWcXn4VPxcbzqdAKpvQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1](https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16ABjEZaBrhhacicBOk87DRb84oRJGWicBbFn33JPWcXn4VPxcbzqdAKpvQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

[https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16AwCEIibV9eHf07JK7L2Bn2RicRaxK0rc0rwAv9qHq0n7z1OOjwzOW4CIg/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1](https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16AwCEIibV9eHf07JK7L2Bn2RicRaxK0rc0rwAv9qHq0n7z1OOjwzOW4CIg/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

[https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp8LoicEcnTWS9ZKajq8j6CSOZ7aekT0okW0s5F0AfJ9dIN3bpEhLQEczIuhWo3BmhgtE4tbm6n06Vw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1](https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp8LoicEcnTWS9ZKajq8j6CSOZ7aekT0okW0s5F0AfJ9dIN3bpEhLQEczIuhWo3BmhgtE4tbm6n06Vw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

[https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16AOhSzGJZVMRNIIiakQcFZQmogVMTcficCOT3ticIt79wj2eJMR68oaChhw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1](https://mmbiz.qpic.cn/sz_mmbiz_png/zZAR4Ynqicp98XsvBLpVLVxsIXVCeib16AOhSzGJZVMRNIIiakQcFZQmogVMTcficCOT3ticIt79wj2eJMR68oaChhw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

3.进入github中，复制所需脚本代码，如ztebbs.js。点击"+"将代码粘贴到编辑器内，并点击保存。
...
5.填写分配置表的内容，如ztebbs表中第一列填的上述准备工作中获得到的所需要的值。
